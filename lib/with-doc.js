...
import Heading, { H3, H4 } from '~/components/base/heading'
...
import DocsNavbarDesktop from '~/components/custom/navbar'
            ...
            <FreezePageScroll>
              ...
              >
                <DocsNavbarDesktop
                  ...
                  setSidebarScrollPosition={val =>
                    (this.sidebar.scrollTop = val)}
                />
              </div>
            </FreezePageScroll>
