...
export default function withDoc(options) {
  return function withContent(content) {
    const DocPage = props => (
      <Page>
        <Head titlePrefix="" title={`${options.title} - Expo Documentation`} />
        ...
        <FreezePageScroll>
          <div className="sidebar">
            ...
            <div style={{ marginBottom: 20 }} className="footnote">
              Built with
              {' '}
              <a href="https://zeit.co/blog/better-documentation">Zeit docs</a>
            </div>
          </div>
        </FreezePageScroll>
        <div>
