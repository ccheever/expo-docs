...
-   **modules ${<InlineCode>{`(Array<number>|number)`}</InlineCode>}** -- An array of \`require('path/to/file')\`. Can also be just one module without an Array.
...
-   **module ${<InlineCode>{`(number)`}</InlineCode>}** -- The value of \`require('path/to/file')\` for the asset
