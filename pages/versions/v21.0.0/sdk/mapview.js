...
-   **If you already have not configured Google Sign In**
    ...
    9.  Run ${<InlineCode>{`keytool -list -printcert -jarfile growler.apk | grep SHA1 | awk '{ print $2 }'`}</InlineCode>} where \`growler.apk\` is the path to the apk you built in step 1.
