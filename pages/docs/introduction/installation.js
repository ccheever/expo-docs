...
If you are a macOS user, you may want to use \`nvm\` to manage versions of Node. This makes it easy to upgrade and downgrade while you're doing development. [Install it using these instructions](https://github.com/creationix/nvm#installation).
