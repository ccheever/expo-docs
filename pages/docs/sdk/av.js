...
-   ${<InlineCode>{`playbackObject.loadAsync(source, initialStatus = {}, downloadFirst = true)`}</InlineCode>}
    ...
    -   **source (_object_ / _number_ / _Asset_)** -- The source of the media. The following forms are supported:
        ...
        -   A dictionary of the form ${<InlineCode>{`{ uri: 'http://path/to/file' }`}</InlineCode>} with a network URL pointing to a media file on the web.
    ...
    -   **initialStatus (_PlaybackStatusToSet_)** -- The initial intended \`PlaybackStatusToSet\` of the \`playbackObject\`, whose values will override the default initial playback status. This value defaults to ${<InlineCode>{`{}`}</InlineCode>} if no parameter is passed. See below for details on \`PlaybackStatusToSet\` and the default initial playback status.
...
-   \`playbackObject.playAsync()\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ shouldPlay: true }`}</InlineCode>})\`.
...
-   \`playbackObject.playFromPositionAsync(millis)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ shouldPlay: true, positionMillis: millis }`}</InlineCode>})\`.
...
-   \`playbackObject.pauseAsync()\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ shouldPlay: false }`}</InlineCode>})\`.

-   \`playbackObject.stopAsync()\`

    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ shouldPlay: false, positionMillis: 0 }`}</InlineCode>})\`.

-   \`playbackObject.setPositionAsync(millis)\`

    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ positionMillis: millis }`}</InlineCode>})\`.
...
-   \`playbackObject.setRateAsync(value, shouldCorrectPitch)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ rate: value, shouldCorrectPitch: shouldCorrectPitch }`}</InlineCode>})\`.
...
-   \`playbackObject.setVolumeAsync(value)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ volume: value }`}</InlineCode>})\`.
...
-   \`playbackObject.setIsMutedAsync(value)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ isMuted: value }`}</InlineCode>})\`.
...
-   \`playbackObject.setIsLoopingAsync(value)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ isLooping: value }`}</InlineCode>})\`.
...
-   \`playbackObject.setProgressUpdateIntervalAsync(millis)\`
    ...
    This is equivalent to \`playbackObject.setStatusAsync(${<InlineCode>{`{ progressUpdateIntervalMillis: millis }`}</InlineCode>})\`.
