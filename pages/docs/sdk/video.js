...
-   A dictionary of the form ${<InlineCode>{`{ uri: 'http://path/to/file' }`}</InlineCode>} with a network URL pointing to a video file on the web.
...
-   A dictionary of the form ${<InlineCode>{`{ uri: 'http://path/to/file' }`}</InlineCode>} with a network URL pointing to a image file on the web.
