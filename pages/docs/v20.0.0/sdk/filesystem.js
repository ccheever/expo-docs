...
If no item exists at this URI, returns ${<InlineCode>{`{ exists: false, isDirectory: false }`}</InlineCode>}. Else returns an object with the following fields:
...
${<Code>{`const callback = downloadProgress => {
