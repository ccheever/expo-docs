...
${
    <Image
      ...
      width={1000}
      height={408}
      caption="Expo Project Lifecycle"
    />
  }
...
You can share this link immediately with anybody who has the Expo Client app. [Read more about Publishing here](../guides/publishing).
...
When you're ready to list your app officially on the Apple App Store and Google Play Store, Expo can generate deployment-ready \`.ipa\` and \`.apk\` archives which are ready to submit to Apple and Google. We generate them on our servers, so you still don't need any Apple or Google software. See [Building Standalone Apps](../guides/building-standalone-apps).

## Changing Native Code
You can take your app all the way to the App Store and Play Store while writing only JS. However, if you run into special advanced needs which aren't covered by Expo, we provide the ability to [detach to ExpoKit](../guides/detach), which is a native Xcode and Android Studio representation of your Expo project.
