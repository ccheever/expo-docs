...
${
  <Image
    src={`${ASSETS_URL}/docs/guides/xde-logs.png`}
    width={1200}
    height={861}
    caption="XDE window with logs"
  />
}
...
${
  <Image
    src={`${ASSETS_URL}/docs/guides/xde-logs-device-picker.png`}
    width={1200}
    height={577}
    caption="XDE window with device picker selected"
  />
}
